...
#define NODE_MAIN_LOGGER_NAME "cmd_vel_mux_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcmd_vel_mux.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<cmd_vel_mux::CmdVelMux>";
